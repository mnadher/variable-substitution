            ...
            if (resultNode != undefined) {
                if (resultNode.isEnd) {
                    switch (typeof (jsonObject[jsonChild])) {
                        ...
                        case null:
                            try {
                                console.log('JSON:SubstitutingValueonKeyWithObject', jsonChild, resultNode.value);
                            ...
                            break;
                        case 'string':
                            console.log('String:SubstitutingValueonKeyWithObject', jsonChild, resultNode.value);
                            //jsonObject[jsonChild] = resultNode.value;
                            jsonObject[jsonChild] = JSON.parse(resultNode.value);
                    }
                    isValueChanged = true;
