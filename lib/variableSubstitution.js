            ...
            for (let file of matchedFiles) {
                ...
                if (this.isJson(file, fileContent)) {
                    ...
                    if (isJsonSubstitutionApplied) {
                        console.log("custom logs: This is Kamil");
                        fs.writeFileSync(file, (fileEncodeType.withBOM ? '\uFEFF' : '') + JSON.stringify(jsonObject,null,4).replaceAll('\',''), { encoding: fileEncodeType.encoding });
